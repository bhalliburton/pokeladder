...
@else
    ...
    @else
        ...
        @if ($this->game->accepted === 1)
            ...
            <h4 class="mt-6 text-4xl font-extrabold text-gray-900">You can still refuse if it isn't working out</h4>
            <p>
            <span class="inline-flex mt-5 rounded-md shadow-sm">
        ...
        @else
            <h4 class="mt-6 text-4xl font-extrabold text-gray-900">Make sure you accept the game! Don't be like Trainer Chip!</h4>
            <p>
            <span class="inline-flex mt-5 rounded-md shadow-sm">
